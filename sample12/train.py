...
def train():
    ...
    parser.add_argument('--dir', type=str, default='./sample12/train_images/')
    ...
    parser.add_argument('--out', '-o', type=str, default='sample12/img/')
